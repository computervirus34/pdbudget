        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix" style="background-color:#28a745;">
                ...
                <div class="col-sm-3" style="text-align: center;">
                    <table>
                        <tr>
                            <td id="userName">Welcome <asp:LoginName ID="LoginName1" runat="server" Font-Bold="true" /></td>
                            <td id="Logout"><asp:LoginStatus ID="LoginStatus1" runat="server" CssClass="btn btn-warning" /></td>
                        </tr>
                    </table>
                </div>
            </div>
